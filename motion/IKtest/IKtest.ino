...
#define SQUARE_SIZE 52.0 // 한 칸의 크기 (20mm)
#define ROBOT_ARM_OFFSET 25.0        // 로봇팔 중심과 체스판 시작점 사이의 거리 (mm)
...
#define X_COMP_PER_COL   6.0   // 열 하나 증가할 때 x 보정량 (mm)
